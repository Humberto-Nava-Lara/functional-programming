...
public interface CustomerRegistrationValidator extends Function<Customer, ValidationResult>{
	...
	static CustomerRegistrationValidator isAnAdult() {
		return customer -> Period.between(customer.getDob(), LocalDate.now()).getYears() > 18 ? ValidationResult.SUCCES : ValidationResult.IS_NOT_AN_ADULT;
	}
	...
	enum ValidationResult{
		SUCCES, PHONE_NUMBER_NOT_VALID, EMAIL_NOT_VALID, IS_NOT_AN_ADULT
	}
}
